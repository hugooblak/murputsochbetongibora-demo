 ...
 * Slug: murputsochbetongibora/storm-steps
...
<div class="wp-block-group alignfull mu-sec-steps" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"align":"wide"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"mu-step-num"} -->
<p class="mu-step-num"><?php echo (int) $i + 1; ?></p>
<!-- /wp:paragraph -->
