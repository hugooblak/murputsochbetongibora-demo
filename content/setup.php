<?php
/**
 * Demo site setup for Mur Puts och Betong I Borås AB.
 *
 ...
 *
 * @package Mur Puts och Betong I Borås AB
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Mur Puts och Betong I Borås AB' );
...
$home = nps_page(
	...
	nps_pattern( 'murputsochbetongibora/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'murputsochbetongibora/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'murputsochbetongibora/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'murputsochbetongibora/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'murputsochbetongibora/thank-you' ),
...
<p class="has-large-font-size">Mur Puts och Betong I Borås AB är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Mur Puts och Betong I Borås AB', $about_content . "\n\n" . nps_pattern( 'murputsochbetongibora/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'murputsochbetongibora/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Mur Puts och Betong I Borås AB uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Mur Puts och Betong I Borås AB demo ready.' );
